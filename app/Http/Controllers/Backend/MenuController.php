...
class MenuController extends Controller
{
    ...
    {
        $menusList = $this->repo->findAll()->pluck('name', 'id');
        $record = $this->repo->createModel();
        return Theme::view($this->getViewName(__FUNCTION__),compact(['record', 'menuList']));
    }
    ...
    {
        $menusList = $this->repo->findAll()->pluck('name', 'id');
        return Theme::view($this->getViewName(__FUNCTION__),compact(['record', 'menusList']));
    }
