        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table id="book_categories" class="table table-bordered table-hover">
                        <thead>
                        <tr>
                            <th>#</th>
                        ...
                        @foreach($records as $record)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        @if($record->is_active)
                                            {!! link_to_route('book_category', trans('common.show'), $record->slug, ['target' => '_blank', 'class' => 'btn btn-info btn-xs'] ) !!}
                                        @endif
