...
class Article extends Eloquent
{
    ...
    protected $fillable = ['user_id', 'article_author_id', 'title', 'slug', 'short_url', 'subtitle', 'spot', 'content', 'description', 'keywords', 'order', 'status', 'is_cuff', 'is_comment','is_active'];
