...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <!--Top header start-->
            <h3 class="ls-top-header">{{trans('biography::biography.management')}}</h3>
            <!--Top header end -->

            <!--Top breadcrumb start -->
            <ol class="breadcrumb">
                <li><a href="{!! URL::route('dashboard') !!}"><i class="fa fa-home"></i></a></li>
                <li><a href="{!! URL::route('biography.index') !!}"> {{ trans('biography::biography.biographies') }} </a></li>
                <li class="active"> {{ trans('biography::common.add_update') }}</li>
            </ol>
            <!--Top breadcrumb start -->
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-light-blue">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('slug', trans('biography::biography.slug'),['class'=> 'col-lg-2 control-label']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                {!! Form::textarea('content', $record->content, ['placeholder' => trans('biography::biography.content') ,'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('photo', trans('biography::biography.photo'),['class'=> 'col-lg-2 control-label']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('description', trans('biography::biography.description'),['class'=> 'col-lg-2 control-label']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('keywords', trans('biography::biography.keywords'),['class'=> 'col-lg-2 control-label']) !!}

                            <div class="col-lg-10">
                                {!! Form::textarea('keywords', $record->keywords, ['placeholder' => trans('biography::biography.keywords') ,'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('order', trans('biography::biography.order'),['class'=> 'col-lg-2 control-label']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('hit', trans('biography::biography.hit'),['class'=> 'col-lg-2 control-label']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            {{trans('biography::common.status')}}
                            <div class="col-lg-offset-2 col-lg-10">
                                <div class="checkbox i-checks">
                                    <label>
                                        {!! Form::checkbox('is_cuff', null , $record->is_cuff) !!}
                                        <i></i> {{trans('biography::common.is_cuff')}}
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-offset-2 col-lg-10">
                                <div class="checkbox i-checks">
                                    <label>
                                        ...
                                        <i></i> {{trans('biography::common.is_active')}}
                                    </label>
                                </div>
                            </div>
                        </div>
