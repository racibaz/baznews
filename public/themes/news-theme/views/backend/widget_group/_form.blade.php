...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <!--Top header start-->
            <h3 class="ls-top-header">{{trans('widget_group.management')}}</h3>
            <!--Top header end -->

            <!--Top breadcrumb start -->
            <ol class="breadcrumb">
                <li><a href="{!! URL::route('dashboard') !!}"><i class="fa fa-home"></i></a></li>
                <li><a href="{!! URL::route('widget_group.index') !!}"> {{ trans('widget_group.widgets') }} </a></li>
            ...
            <div class="panel panel-light-blue">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            {!! Form::label('name', trans('widget_group.name'),['class'=> 'col-lg-2 control-label']) !!}
