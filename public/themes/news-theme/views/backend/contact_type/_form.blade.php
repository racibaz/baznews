...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <!--Top header start-->
                <h3 class="ls-top-header">{{trans('contact_type.management')}}</h3>
                <!--Top header end -->

                <!--Top breadcrumb start -->
                <ol class="breadcrumb">
                    <li><a href="{!! URL::route('dashboard') !!}"><i class="fa fa-home"></i></a></li>
                    <li><a href="{!! URL::route('contact_type.index') !!}"> {{ trans('contact_type.management') }} </a>
                    </li>
                ...
                <div class="panel panel-light-blue">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                {!! Form::label('name', trans('contact_type.name'),['class'=> 'col-lg-2 control-label']) !!}
