                ...
                <div class="box-body">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li><a href="{!! route('configClear') !!}">
                                    <span>Konfigirasyon Ayarlarını lerini Temizle</span></a></li>
                            <li><a href="{!! route('configCache') !!}">
                                    <span>Konfigirasyon Ayarlarını lerini Cache le</span></a></li>
                        </ul>
                        <br/><br/>
                    </div>
