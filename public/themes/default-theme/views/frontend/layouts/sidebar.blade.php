    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{!! Redis::get('logo') !!}" class="img-circle" alt="User Image">
            </div>
        ...
        <ul class="sidebar-menu">
            ...
            {{--<li><a href="{!! route('author.index') !!}"><i class="fa fa-book"></i> <span>yazarlar</span></a></li>--}}
            ...
            {{--@foreach($menus as $menu)--}}
                {{--<li><a href="{{$menu->url}}"><i class="fa fa-circle-o text-red"></i> <span>{{$menu->name}}</span></a></li>--}}
            {{--@endforeach--}}
